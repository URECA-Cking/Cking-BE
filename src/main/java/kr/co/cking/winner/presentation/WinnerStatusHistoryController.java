...
public class WinnerStatusHistoryController {
    ...
    @Operation(
            ...
            description = "인증된 호출자 Member와 역할을 검증합니다. USER는 본인 Winner만, ADMIN은 모든 Winner의 "
    ...
    public ApiResponse<List<WinnerStatusHistoryResult>> getHistory(
        ...
        return ApiResponse.success(winnerStatusHistoryQueryService.getHistory(winnerId, memberId));
    }
}
