...
public class EntryController {
    ...
    /** 인증된 사용자의 실시간 Event 응모 현황을 조회한다. */
    @Operation(
            summary = "실시간 응모 현황 조회",
            description = "인증된 사용자의 이벤트 참여자 수·누적 사용 응모권 수와 본인 사용 응모권 수를 조회합니다. "
                    + "표시용 값이며 응모 승인·추첨의 근거가 아닙니다. "
    ...
    public ApiResponse<EntryStatusResponse> getEntryStatus(
        ...
        return ApiResponse.success(entryStatusQueryService.getStatus(eventId, memberId));
    }
