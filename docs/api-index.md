...
| 15 | 외부 | Creator 운영 | CREATOR | POST | `/api/creator/events` | Event 생성 | P1 |
| 16 | 외부 | Creator 운영 | CREATOR | PATCH | `/api/creator/events/{eventId}` | Event 수정 | P1 |
...
| 30 | 외부 | Creator 승인 | USER | POST | `/api/creator/applications` | Creator 신청 | P1 |
